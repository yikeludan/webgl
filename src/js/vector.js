export default class Vector {
     ...
     * @return {Vector2}
     */
    add (v1, v2) { // 可以用于处理对象匀加速运动，或者计算组合运动后的的平行四边形对角线的长度及方向
        let v = []
        v[0] = v1[0] + v2[0]
        v[1] = v1[1] + v2[1]
        return v
     ...
     * @return {Vector2}
     */
    subtract (v1, v2) { // 可以用于处理对象匀减速运动，或者计算组合运动后的三角形第三边的长度及方向
        let v = []
        v[0] = v1[0] - v2[0]
        v[1] = v1[1] - v2[1]
        return v
     ...
     * @return {number}
     */
    dotProduct (v1, v2) { // 点乘的几何意义是可以用来表征或计算两个向量之间的夹角，以及在 b 向量在 a 向量方向上的投影，因此可以用于描述对象两次运动的方向是否相同
     ...
     * @return {Vector2}
     */
    lerp (v1, v2, percent) { // 沿用行内的线性插值名称 lerp
        let v = []
